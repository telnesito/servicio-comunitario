    ...
    <Box display={'flex'} flexDirection={'column'} alignItems={'center'} width={'80%'} height={'100vh'} minHeight={'700px'} bgcolor={'var(--backgroundColor)'} >
      ...
      <Box padding={'10px'} width={'95%'}>
        <Paper elevation={1} sx={{ padding: '10px' }}>
          ...
          <TextField placeholder="Ingrese titulo del evento" fullWidth ></TextField>
        </Paper>
      </Box>
      ...
      <Box width={'95%'} height={'450px'} color={'black'}>
        ...
        <Box gap={'10px'} display={'flex'}>
          <Paper sx={{ padding: '10px', mt: '10px' }} elevation={1}>
            <Box>
              <Typography padding={'5px'} variant="h6" width={'100%'} fontWeight={'700'} color={'var(--primaryColor)'}>Fecha</Typography>
              <TextField type="date" />
            </Box>
          </Paper>
          <Paper sx={{ padding: '10px', mt: '10px' }} elevation={1}>
            <Box>
              <Typography padding={'5px'} variant="h6" width={'100%'} fontWeight={'700'} color={'var(--primaryColor)'}>Imagen principal</Typography>
              <TextField type="file" />
            </Box>
          </Paper>
        </Box>
        <Button sx={{ mt: '10px', bgcolor: 'var(--primaryColor)' }} onClick={() => setOpen(true)} variant="contained">Publicar</Button>

        <Button sx={{ mt: '10px', ml: '10px', borderColor: 'var(--primaryColor)', color: 'var(--primaryColor)' }} variant="outlined">Guardar</Button>
      </Box>
